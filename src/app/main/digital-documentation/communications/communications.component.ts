  ...
  async ListEmpresasAportes(id: any) {
    ...
    await this.apiService.Ejecutar(this.xAPI).subscribe(
      (data) => {
        ...
        this.rowsEmpresasContactos.push(JSON.parse(e.contactos))
        this.rowsEmpresasUsuario.push(JSON.parse(e.usuario))
      });
      },
      (error) => {
        console.log(error)
    ...
    console.info('Usuarios',this.rowsEmpresasUsuario)
